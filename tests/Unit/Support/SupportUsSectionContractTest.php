...
final class SupportUsSectionContractTest extends TestCase {
	...
	public function testCssContractHasFocusAndReducedMotion(): void {
		...
		self::assertStringContainsString('bc-support-us', $css);
		...
		if (is_file($dedicated)) {
			...
			self::assertStringContainsString('#app-content.bc-app--admin-support-us ul.bc-support-us-page__trust', $pageCss);
			...
			self::assertMatchesRegularExpression(
				'/\.bc-support-us--page \.bc-support-us__primary\s*\{[^}]*max-width:\s*none/s',
				$pageCss,
